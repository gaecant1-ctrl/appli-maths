...
export function textePrecision(p){
  return {
    1:"dixième",
    2:"centième",
    3:"millième"
...
export function debugArbre(expr, depth = 0) {
...
export function avecMethodesListe(arr) {
...
export function avecMethodesDict(obj = {}) {
...
export function estDans(valeur, liste1 = [], liste2 = []) {
...
export function makeSeed(base, niveau, type, index) {
