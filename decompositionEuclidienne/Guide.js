/* ==============================================
   Guide.js — overlay "Mode d'emploi" de l'appli Décomposition Euclidienne
   ----------------------------------------------
...
class GuideAppli {
  ...
  _construireOverlay() {
    ...
    contenu.innerHTML = `
      <h3>Objectif</h3>
      <p>Trouve le quotient <b>q</b> et le reste <b>r</b> de la division euclidienne d'un nombre A par un diviseur b, tel que A = b×q + r (avec 0 ≤ r &lt; b).</p>
      ...
      <h3>Répondre</h3>
      <p>Calcule le quotient et le reste puis saisis-les dans les champs prévus, et valide avec la touche Entrée.</p>
