/* ==============================================
   Guide.js — overlay "Mode d'emploi" de l'appli de factorisation
   ----------------------------------------------
...
class GuideAppli {
  ...
  _construireOverlay() {
    ...
    contenu.innerHTML = `
      <h3>Objectif</h3>
      <p>Entraîne-toi à factoriser des expressions littérales au maximum.</p>

      <h3>Type de factorisation</h3>
      <p>Choisis un ou plusieurs types dans le panneau de gauche : <b>Facteur simple</b> (un monôme en facteur commun), <b>Facteur complexe</b> (un binôme en facteur commun, ex : (2x+3)), <b>Identité remarquable</b> (a² − b²). Au moins un type doit rester actif.</p>

      <h3>Facteur scalaire entier</h3>
      <p>Choisis si un facteur numérique commun (ex : le 2 dans 2x + 4y) doit obligatoirement être extrait pour que la réponse soit validée.</p>
      ...
      <h3>Répondre</h3>
      <p>Saisis ta factorisation dans le champ de réponse puis valide avec la touche Entrée. En cas d'erreur, corrige et réessaie. Le bouton « Renoncer » passe à la question suivante sans compter de point.</p>

      <h3>Fiche papier</h3>
      <p>Génère une fiche imprimable de 18 exercices (à imprimer ou à exporter en LaTeX) avec les réglages actuellement sélectionnés.</p>
    `;
