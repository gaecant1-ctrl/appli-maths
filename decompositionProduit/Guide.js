/* ==============================================
   Guide.js — overlay "Mode d'emploi" de l'appli Décomposition en Produit de Facteurs Premiers
   ----------------------------------------------
...
class GuideAppli {
  ...
  _construireOverlay() {
    ...
    contenu.innerHTML = `
      <h3>Objectif</h3>
      <p>Décompose le nombre proposé en produit de ses facteurs premiers (ex : \\(60 = 2^2 \\times 3 \\times 5\\)).</p>
      ...
      <h3>Répondre</h3>
      <p>Écris la décomposition en produit de facteurs premiers, dans l'ordre que tu veux, et valide avec la touche Entrée.</p>
