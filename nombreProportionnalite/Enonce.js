...
genVariant(index) {
const optionsPartagees = this.sharedOptions || {};
    
    let type = optionsPartagees.typeForce ? optionsPartagees.typeForce : this.rng.int(1, 25);
    let sousCasForce = optionsPartagees.sousCasForce ? optionsPartagees.sousCasForce : null;
...
case 18: {
            const ratio = generateRatio(this.rng, 'strict');
            const a = ratio.c; const b = ratio.b;
            const k = this.rng.pick([2, 3, 4, 5, 6]);
            const tot = b * k; const g = a * k; const f = tot - g;
            ...
            // MODIFICATION ICI : On utilise le sous-cas forcé s'il existe, sinon l'ancien hasard
            const sousCas = sousCasForce ? sousCasForce : this.rng.pick([1, 2, 3]);
            ...
            variantOptions = { "modeCorrection.nombreAff": "fractionSimple", "policies.format.nombre": "fractionSimple", "policies.format.uniteCible": {} };
            break;
        }
        ...
        case 19: {
            ...
            variantOptions = { "modeCorrection.nombreAff": "pourcentage", "policies.format.nombre": "pourcentage", "policies.format.uniteCible": {} };
            break;
        }
        ...
        case 20: {
            ...
            // MODIFICATION ICI
            const sousCas = sousCasForce ? sousCasForce : this.rng.pick([1, 2]);
            ...
            variantOptions = { "modeCorrection.nombreAff": "standard", "policies.format.nombre": "standard", "policies.format.uniteCible": {} };
            break;
        }
        ...
        case 21: {
            ...
            const pctA = pctBase; const valA = a * k;
            const nomB = (nomA === 'garçons') ? 'filles' : 'garçons';
            const pctB = 100 - pctBase; const valB = tot - valA;

            // MODIFICATION ICI
            const sousCas = sousCasForce ? sousCasForce : this.rng.pick([1, 2, 3, 4]);
