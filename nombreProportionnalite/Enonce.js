...
case 18 : {
    ...
    const tot = this.rng.pick([10,15,20,25,30]); 
    const f = this.rng.int(2, tot-1);
    const g = tot-f;
    variantGrandeur = new Grandeur(Nombre.fromParts(g, tot), {});
    ...
    quest = `Quelle est la proportion de garcons dans le groupe ? `;
