...
class GuideAppli {
  ...
  _construireOverlay() {
    ...
    contenu.innerHTML = `
      ...
      <b>Saisie</b> : « Construction » (compteurs +/- puis masse totale, comme ci-dessus) ou « Équation » (taper
      directement une égalité comme <b>3a+2b=560g</b> — l'appli vérifie si elle est vraie et si elle isole a ou
      b).<br>
