/* ==============================================
   Guide.js — overlay "Mode d'emploi" de l'appli Décomposition en facteurs premiers
   ----------------------------------------------
...
class GuideAppli {
  ...
  _construireOverlay() {
    ...
    contenu.innerHTML = `
      <h3>Objectif</h3>
      <p>Un nombre est décomposé en produit de facteurs premiers (ex : \\(120 = 2^3 \\times 3 \\times 5\\)). Coche, parmi une liste de nombres proposés, ceux qui divisent ce nombre.</p>

      <h3>Atelier / Quiz</h3>
      <p><b>Atelier</b> : entraînement libre, exercices illimités, sans score.<br>
      <b>Quiz</b> : clique sur « Commencer le Quiz » pour répondre à une série de questions ; le score s'affiche à la fin.</p>

      <h3>Répondre</h3>
      <p>Coche toutes les cases des nombres qui divisent le nombre proposé, puis clique sur « Valider ».</p>
  ...
  ouvrir() {
    ...
    try {
      if (window.MathJax?.typesetPromise) MathJax.typesetPromise([this.overlay]);
    } catch (e) { /* silencieux */ }
  }
