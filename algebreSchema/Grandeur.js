...
class Grandeur {
  ...
  add(other) {
    ...
    // simplify() : sans elle, l'aller-retour par le facteur de conversion
    // (utile seulement pour une unité non fondamentale, ex: g -> kg -> g)
    // laisse une fraction non réduite ; enchaîné sur plusieurs opérations
    // (mathis+leo+maya...), numérateur/dénominateur grossissent jusqu'à
    // dépasser la précision entière de JS.
